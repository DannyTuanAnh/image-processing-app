...
export default function UploadForm({
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 shadow-2xl">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white">Tải ảnh lên</h2>

        <p className="text-slate-400 text-sm mt-1">
          Chọn hình ảnh từ thiết bị và bắt đầu xử lý.
        </p>
      </div>

      <div className="space-y-6">
        <label className="w-full flex items-center justify-center gap-2 px-4 py-5 rounded-2xl bg-slate-800 hover:bg-slate-700 transition-all duration-300 cursor-pointer border border-white/10 text-white font-medium">
          <Upload size={18} />
